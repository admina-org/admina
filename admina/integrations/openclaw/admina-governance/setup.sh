#!/bin/bash
# ═══════════════════════════════════════════════════════════
#  Admina Governance Sidecar — OpenClaw Installer
#
#  Starts the Admina proxy as a Docker sidecar container
#  for OpenClaw agent governance.
#
#  Usage:
...
CONTAINER_NAME="admina-openclaw-sidecar"
CONFIG_FILE="${SKILL_DIR}/admina.yaml"
...
banner() {
  echo ""
  echo -e "${C}═══════════════════════════════════════════════════════════${N}"
  echo -e "${C}  Admina Governance Sidecar for OpenClaw${N}"
  echo -e "${C}═══════════════════════════════════════════════════════════${N}"
  echo ""
}
...
# Step 3: Export environment variable hint
echo -e "\n${B}[3/3]${N} Configuration"
echo ""
echo -e "  Add to your shell profile or OpenClaw config:"
echo -e "  ${C}export ADMINA_PROXY_URL=${PROXY_URL}${N}"
echo ""
echo -e "${C}═══════════════════════════════════════════════════════════${N}"
echo -e "  ${G}Admina is now governing your OpenClaw agent${N}"
echo -e ""
